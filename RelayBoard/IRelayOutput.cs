namespace RelayBoard
{
    ...
    /// was sent to him. And also allows the output to reset pulse observations.
    /// </summary>
    public unsafe interface IRelayOutput
    {
        ...
        /// if at least one pulse was sent to him. And also allows the output to reset pulse observations.
        /// </summary>
